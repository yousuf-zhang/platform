...
import com.yousuf.platform.common.jpa.BaseRepository;
import com.yousuf.platform.common.jpa.ColumnToBean;
import com.yousuf.platform.common.page.PageData;
import com.yousuf.platform.common.page.QueryParams;
...
public class BaseRepositoryImpl<T, ID extends Serializable> extends SimpleJpaRepository<T, ID> implements BaseRepository<T, ID> {
    ...
    @Override
    public <E> List<E> executeNativeQuery(QueryParams queryParams) {
        String sql = queryParams.getSql();
        if (StringUtils.isNotBlank(queryParams.getOrderBy())) {
            sql += queryParams.getOrderBy();
        }
    ...
    @Override
    public <E> E executeNativeSingleQuery(QueryParams queryParams) {
    ...
    @Override
    public <E> PageData<E> executePageNativeQuery(QueryParams queryParams) {
